    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cuisine_types', models.CharField(choices=[('african', 'African'), ('american', 'American'), ('caribbean', 'Caribbean'), ('asian', 'Asian'), ('chinese', 'Chinese'), ('indian', 'Indian'), ('italian', 'Italian'), ('british', 'British'), ('french', 'French')], default='african', max_length=50)),
